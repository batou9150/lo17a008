...
public class tal_sqlLexer extends Lexer {
	...
	public final void mSELECT() throws RecognitionException {
		try {
			...
			// /volsme/users/lo17a008/Téléchargements/tal_sql.g:3:8: (
			// 'vouloir' )
			// /volsme/users/lo17a008/Téléchargements/tal_sql.g:3:10:
			// 'vouloir'
			{
				match("vouloir");
	...
	public final void mARTICLE() throws RecognitionException {
		try {
			int _type = ARTICLE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// /volsme/users/lo17a008/Téléchargements/tal_sql.g:6:9: (
			// 'article' )
			// /volsme/users/lo17a008/Téléchargements/tal_sql.g:6:11:
			// 'article'
			{
				match("article");
	...
	public final void mCONJ() throws RecognitionException {
		try {
			int _type = CONJ;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// /volsme/users/lo17a008/Téléchargements/tal_sql.g:12:6: ( 'et' |
			// 'ou' )
			int alt1 = 2;
	...
	public final void mMOT() throws RecognitionException {
		try {
			int _type = MOT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// /volsme/users/lo17a008/Téléchargements/tal_sql.g:18:5: ( 'mot'
			// | 'contenir' | 'parler' )
			int alt2 = 3;
			switch (input.LA(1)) {
			case 'm': {
			...
			// /volsme/users/lo17a008/Téléchargements/tal_sql.g:18:7: 'mot'
			{
				...
				break;
			case 2:
			// /volsme/users/lo17a008/Téléchargements/tal_sql.g:18:15:
			// 'contenir'
			{
				match("contenir");
				...
				break;
			case 3:
			// /volsme/users/lo17a008/Téléchargements/tal_sql.g:18:28:
			// 'parler'
			{
				match("parler");
	...
	public final void mWS() throws RecognitionException {
		try {
			int _type = WS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// /volsme/users/lo17a008/Téléchargements/tal_sql.g:21:5: ( ( ' '
			// | '\\t' | '\\r' | 'je' | 'qui' | 'dont' ) | '\\n' )
			int alt4 = 2;
			int LA4_0 = input.LA(1);

			if ((LA4_0 == '\t' || LA4_0 == '\r' || LA4_0 == ' ' || LA4_0 == 'd'
					|| LA4_0 == 'j' || LA4_0 == 'q')) {
				alt4 = 1;
			} else if ((LA4_0 == '\n')) {
				alt4 = 2;
			...
			switch (alt4) {
			case 1:
			// /volsme/users/lo17a008/Téléchargements/tal_sql.g:21:7: ( ' ' |
			// '\\t' | '\\r' | 'je' | 'qui' | 'dont' )
			{
				// /volsme/users/lo17a008/Téléchargements/tal_sql.g:21:7: (
				// ' ' | '\\t' | '\\r' | 'je' | 'qui' | 'dont' )
				...
				// '\\t'
				{
					...
					break;
				case 3:
				// /volsme/users/lo17a008/Téléchargements/tal_sql.g:21:20:
				// '\\r'
				{
					match('\r');
					...
					break;
				case 4:
				// /volsme/users/lo17a008/Téléchargements/tal_sql.g:21:27:
				// 'je'
				{
					match("je");
					...
					break;
				case 5:
				// /volsme/users/lo17a008/Téléchargements/tal_sql.g:21:34:
				// 'qui'
				{
					match("qui");
					...
					break;
				case 6:
				// /volsme/users/lo17a008/Téléchargements/tal_sql.g:21:42:
				// 'dont'
				{
					match("dont");
	...
	public final void mVAR() throws RecognitionException {
		try {
			int _type = VAR;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// /volsme/users/lo17a008/Téléchargements/tal_sql.g:24:6: ( ( 'A'
			// .. 'Z' | 'a' .. 'z' ) ( 'a' .. 'z' )+ )
			// /volsme/users/lo17a008/Téléchargements/tal_sql.g:24:8: ( 'A' ..
			// 'Z' | 'a' .. 'z' ) ( 'a' .. 'z' )+
			{
				...
				// /volsme/users/lo17a008/Téléchargements/tal_sql.g:24:30: (
				// 'a' .. 'z' )+
				int cnt5 = 0;
				loop5: do {
					int alt5 = 2;
					...
					switch (alt5) {
					case 1:
					// /volsme/users/lo17a008/Téléchargements/tal_sql.g:24:31:
					// 'a' .. 'z'
					{
						matchRange('a', 'z');
	...
	public void mTokens() throws RecognitionException {
		// /volsme/users/lo17a008/Téléchargements/tal_sql.g:1:8: ( SELECT |
		// ARTICLE | PAGE | CONJ | POINT | MOT | WS | VAR )
		int alt6 = 8;
	...
	static final String DFA6_eotS = "\16\uffff\3\15\2\34\2\15\1\11\6\15\1\uffff\1\45\1\15\1\11\3\15\1"
			+ "\52\1\15\1\uffff\1\15\1\11\2\15\1\uffff\4\15\1\45\1\15\1\64\1\65"
			+ "\1\15\2\uffff\1\45";
	static final String DFA6_eofS = "\67\uffff";
	static final String DFA6_minS = "\1\11\5\141\1\uffff\2\141\1\uffff\3\141\1\uffff\1\165\1\164\1\147"
			...
			+ "\1\162\2\uffff\1\141";
	static final String DFA6_maxS = "\6\172\1\uffff\2\172\1\uffff\3\172\1\uffff\1\165\1\164\1\162\2\172"
			...
			+ "\162\2\uffff\1\172";
	static final String DFA6_acceptS = "\6\uffff\1\5\2\uffff\1\7\3\uffff\1\10\16\uffff\1\4\10\uffff\1\6"
			+ "\4\uffff\1\3\11\uffff\1\1\1\2\1\uffff";
	static final String DFA6_specialS = "\67\uffff}>";
	static final String[] DFA6_transitionS = {
			"\2\11\2\uffff\1\11\22\uffff\1\11\15\uffff\1\6\22\uffff\32\15"
					+ "\6\uffff\1\2\1\15\1\10\1\14\1\4\4\15\1\12\2\15\1\7\1\15\1\5"
					+ "\1\3\1\13\4\15\1\1\4\15", "\16\15\1\16\13\15",
			"\21\15\1\17\10\15", "\1\20\31\15", "\23\15\1\21\6\15",
			"\24\15\1\22\5\15", "", "\16\15\1\23\13\15", "\16\15\1\24\13\15",
			"", "\4\15\1\25\25\15", "\24\15\1\26\5\15", "\16\15\1\27\13\15",
			"", "\1\30", "\1\31", "\1\32\12\uffff\1\33", "\32\15", "\32\15",
			"\1\35", "\1\36", "\32\15", "\1\37", "\1\40", "\1\41", "\1\42",
			"\1\43", "\1\44", "", "\32\15", "\1\46", "\32\15", "\1\47",
			"\1\50", "\1\51", "\32\15", "\1\53", "", "\1\54", "\32\15",
			"\1\55", "\1\56", "", "\1\57", "\1\60", "\1\61", "\1\62", "\32\15",
			"\1\63", "\32\15", "\32\15", "\1\66", "", "", "\32\15" };
