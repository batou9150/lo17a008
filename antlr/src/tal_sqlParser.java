...
public class tal_sqlParser extends DebugParser {
    ...
    public static final String[] ruleNames = new String[] {
        "invalidRule", "listerequetes", "param", "params", "requete"
    };
    public static final boolean[] decisionCanBacktrack = new boolean[] {
        ...
        public tal_sqlParser(TokenStream input, int port, RecognizerSharedState state) {
            super(input, state);
    ...
    // /volsme/users/lo17a008/Téléchargements/tal_sql.g:27:1: listerequetes returns [String sql = \"\"] : r= requete POINT ;
    public final String listerequetes() throws RecognitionException {
        ...
        Arbre lr_arbre;
        try { dbg.enterRule(getGrammarFileName(), "listerequetes");
        if ( getRuleLevel()==0 ) {dbg.commence();}
        incRuleLevel();
        dbg.location(27, 1);

        try {
            // /volsme/users/lo17a008/Téléchargements/tal_sql.g:28:25: (r= requete POINT )
            dbg.enterAlt(1);

            // /volsme/users/lo17a008/Téléchargements/tal_sql.g:29:3: r= requete POINT
            {
            dbg.location(29,5);
    ...
    // $ANTLR start "requete"
    // /volsme/users/lo17a008/Téléchargements/tal_sql.g:36:1: requete returns [Arbre req_arbre = new Arbre(\"\")] : SELECT ( ARTICLE | PAGE ) MOT ps= params ;
    public final Arbre requete() throws RecognitionException {
        ...
        Arbre ps_arbre;
        try { dbg.enterRule(getGrammarFileName(), "requete");
        if ( getRuleLevel()==0 ) {dbg.commence();}
        incRuleLevel();
        dbg.location(36, 1);

        try {
            // /volsme/users/lo17a008/Téléchargements/tal_sql.g:37:26: ( SELECT ( ARTICLE | PAGE ) MOT ps= params )
            dbg.enterAlt(1);

            // /volsme/users/lo17a008/Téléchargements/tal_sql.g:38:3: SELECT ( ARTICLE | PAGE ) MOT ps= params
            {
            dbg.location(38,3);
            ...
            dbg.location(42,3);
            // /volsme/users/lo17a008/Téléchargements/tal_sql.g:42:3: ( ARTICLE | PAGE )
            int alt1=2;
            ...
            switch (alt1) {
                case 1 :
                    ...
                    // /volsme/users/lo17a008/Téléchargements/tal_sql.g:42:4: ARTICLE
                    {
                    dbg.location(42,4);
                ...
                case 2 :
                    ...
                    // /volsme/users/lo17a008/Téléchargements/tal_sql.g:46:6: PAGE
                    {
                    dbg.location(46,6);
    ...
    // $ANTLR start "params"
    // /volsme/users/lo17a008/Téléchargements/tal_sql.g:62:1: params returns [Arbre les_pars_arbre = new Arbre(\"\")] : par1= param ( CONJ par2= param )* ;
    public final Arbre params() throws RecognitionException {
        ...
        try {
            // /volsme/users/lo17a008/Téléchargements/tal_sql.g:63:40: (par1= param ( CONJ par2= param )* )
            dbg.enterAlt(1);

            // /volsme/users/lo17a008/Téléchargements/tal_sql.g:64:3: par1= param ( CONJ par2= param )*
            {
            dbg.location(64,8);
            ...
            dbg.location(69,3);
            // /volsme/users/lo17a008/Téléchargements/tal_sql.g:69:3: ( CONJ par2= param )*
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    // /volsme/users/lo17a008/Téléchargements/tal_sql.g:69:4: CONJ par2= param
            	    {
            	    dbg.location(69,4);
    ...
    // $ANTLR start "param"
    // /volsme/users/lo17a008/Téléchargements/tal_sql.g:78:1: param returns [Arbre lepar_arbre = new Arbre(\"\")] : a= VAR ;
    public final Arbre param() throws RecognitionException {
        ...
        try {
            // /volsme/users/lo17a008/Téléchargements/tal_sql.g:78:51: (a= VAR )
            dbg.enterAlt(1);

            // /volsme/users/lo17a008/Téléchargements/tal_sql.g:79:2: a= VAR
            {
            dbg.location(79,4);
